...
void NeoPixelUSBController::PrintHelpInfo() {
  ...
  Serial.println("    SnakeIn;");
  Serial.println("    SnakeOut;");
  Serial.println("    Snake;");
  Serial.println("    PSnake;");
  Serial.println("    Off;");
